...
public class AnimationViewer extends JPanel implements ActionListener {
	...
	public AnimationViewer() {
		...
		try {
		CarrierShape five = new CarrierShape(15,20,3,3,2000,1500);
		CarrierShape four = new CarrierShape(five._x, five._y, 4, 5, 700, 700);
		DynamicRectangleShape three = new DynamicRectangleShape(five._x, five._y, 3, 2, 400, 300);
		GemShape two = new GemShape(five._x, five._y, 3, 3, 300, 400);
		
		// Populate the list of Shapes.
		_shapes.add(new NewShape(0, 0, 6, 9, 300, 200));
