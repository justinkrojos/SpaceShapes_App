...
public class SpaceShape extends JPanel {
	...
	private void populateModel() {
		...
		_model.add(new RectangleShape(440, 0, 10, 10, 100, 200), root);
		//_model.add(new RectangleShape(0, 0, 5, 7), root);
		_model.add(new GemShape(20, 20, 4, 4, 200, 60, "Space-Shape"), root);
		...
		_model.add(new OvalShape(50,110,2,2,60, 80), root);
		

		CarrierShape child = new CarrierShape(10, 10, 2, 2, 300, 300);
		_model.add(new RectangleShape(10, 10, 10, 10, 100, 50), child);
		_model.add(new DynamicRectangleShape(0, 0, 2, 3, 50, 80, Color.RED), child);
		_model.add(new OvalShape(10,10,2,2, 150, 100), child);
		_model.add(child, root);
		_model.add(new DynamicRectangleShape(0,0,0,20,60,80), root);
	}
